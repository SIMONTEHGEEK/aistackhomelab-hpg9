...
mkdir -p "${DATA_DIR}"/{ollama,open-webui,comfyui/{models/checkpoints,models/loras,models/controlnet,models/vae,models/clip,output,input,custom_nodes},whisper,piper,traefik/certs,portainer}
